...
const SingleProduct = () => {
   ...
   const props = {
      ...
      height: 600,
      zoomWidth: 600,
      img: productState?.images[0]?.url ? productState?.images[0]?.url : "https://w7.pngwing.com/pngs/526/33/png-transparent-apple-watch-series-3-apple-watch-series-2-apple-watch-series-1-watch3-electronics-gadget-apple-watch.png"
   };
                              ...
                              return (
                                 <div className="review" key={index}>
                                    <div className="d-flex gap-10 align-items-center">
                                       <h6 className='mb-0'>Minh Huan</h6>
                                       <ReactStars
                                          count={5}
                                          size={24}
                                          value={item?.star}
