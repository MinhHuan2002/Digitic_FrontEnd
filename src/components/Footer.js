            ...
            <div className="row">
               <div className="col-4">
                  ...
                  <div>
                     ...
                     <a href="tel:+84 369021243" className='mt-3 d-block mb-1 text-white'>
                     +84 369021243
                     </a>
                     <a href="mailto:huannvm2002@gmail.com" className='mt-2 d-block mb-0 text-white'>
                     huannvm2002@gmail.com
                     </a>
         ...
         <div className="container-xxl">
            <div className="row">
               <div className="col-12">
                  <p className='text-center mb-0 text-white'>&copy; {new Date().getFullYear()}; Powered by F-Digitic</p>
               </div>
            </div>
         </div>
      </footer>
